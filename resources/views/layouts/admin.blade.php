...
<head>
    ...
    <title>ABS News Management </title>
    <meta name="description"
        content="ABS News ">
    <meta name="keywords"
        content="ABS News Management">
    <meta name="author" content="Iqonic Design">
    <meta name="DC.title" content="ABS News Management System">

    <script>
        (function () {
            const savedTheme = sessionStorage.getItem('ABS News Management System');
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('admin_asset/images/ChatGPT image Feb.png') }}" />

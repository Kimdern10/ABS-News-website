             ...
             <ul>
               ...
               <li class="clearfix">
                 <div class="utf_post_block_style post-float clearfix">
                   <div class="utf_post_thumb">
                     <a href="#">
                       <img class="img-fluid" src="{{ asset('assets/images/news/review/review2.jpg') }}" alt="Politics" />
                     </a>
                   </div>
                   <div class="utf_post_content">
                     <h2 class="utf_post_title">
                     ...
                     <div class="utf_post_meta">
                       <p>Latest political news, government policies, elections, and public affairs.</p>
                     </div>
                   </div>
                 </div>
               </li>
               ...
               <li class="clearfix">
                 <div class="utf_post_block_style post-float clearfix">
                   <div class="utf_post_thumb">
                     <a href="#">
                       <img class="img-fluid" src="{{ asset('assets/images/news/review/review3.jpg') }}" alt="Sports" />
                     </a>
                   </div>
                   <div class="utf_post_content">
                     <h2 class="utf_post_title">
                     ...
                     <div class="utf_post_meta">
                       <p>Coverage of football, basketball, athletics, competitions, and sporting events.</p>
                     </div>
                   </div>
                 </div>
               </li>
               ...
               <li class="clearfix">
                 <div class="utf_post_block_style post-float clearfix">
                   <div class="utf_post_thumb">
                     <a href="#">
                       <img class="img-fluid" src="{{ asset('assets/images/news/review/review4.jpg') }}" alt="Entertainment" />
                     </a>
                   </div>
                   <div class="utf_post_content">
                     <h2 class="utf_post_title">
                     ...
                     <div class="utf_post_meta">
                       <p>Trending celebrity stories, music, movies, television, and lifestyle updates.</p>
                     </div>
                   </div>
                 </div>
               </li>
               ...
               <li class="clearfix">
                 <div class="utf_post_block_style post-float clearfix">
                   <div class="utf_post_thumb">
                     <a href="#">
                       <img class="img-fluid" src="{{ asset('assets/images/news/review/review2.jpg') }}" alt="Business" />
                     </a>
                   </div>
                   <div class="utf_post_content">
                     <h2 class="utf_post_title">
                     ...
                     <div class="utf_post_meta">
                       <p>Business news, markets, entrepreneurship, finance, and economic developments.</p>
                     </div>
                   </div>
                 </div>
               </li>
               ...
               <li class="clearfix">
                 <div class="utf_post_block_style post-float clearfix">
                   <div class="utf_post_thumb">
                     <a href="#">
                       <img class="img-fluid" src="{{ asset('assets/images/news/review/review3.jpg') }}" alt="Technology" />
                     </a>
                   </div>
                   <div class="utf_post_content">
                     <h2 class="utf_post_title">
                     ...
                     <div class="utf_post_meta">
                       <p>Updates on technology, innovation, gadgets, software, and the digital world.</p>
                     </div>
                   </div>
                 </div>
               </li>
